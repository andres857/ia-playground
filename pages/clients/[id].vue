<template>
    <h3>Client View test</h3>
    <h4>client: {{idClient}}</h4>
    <h4>name: {{ nameClient }}</h4>
...
<script lang="ts" setup>
    ...
    const nameClient = ref(route.query.nameClient)
    const idClient = ref(route.params.id)

    console.log('nameClient:', nameClient.value)
    console.log('idClient:', idClient.value)
